...
needs(DT)      # Data Tables
needs(C3)      # devtools::install_github("FrissAnalytics/shinyJsTutorials/widgets/C3")
needs(spdep)
needs(flexdashboard) # install.packages("flexdashboard", type = "source")
needs(tidyverse)
needs(stringi)
needs(shinyBS) # Pelos botoes de popover e tooltip
needs(shinythemes)
###########
###########
###########
